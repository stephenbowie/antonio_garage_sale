...
export const PAGINATED_VALID_LIST = {
  data: {
    products: [
      {
        id: 1,
  ...
  config: {
    ...
    method: "get",
    url: "https://dummyjson.com/products?limit=20&skip0",
  },
  request: {},
};
...
export const PAGINATED_PRODUCT_LIST2 = {
  "data": {
      "products": [
          {
              "id": 1,
  ...
  "config": {
      ...
      "method": "get",
      "url": "https://dummyjson.com/products?limit=40&skip20"
  },
  "request": {}
}